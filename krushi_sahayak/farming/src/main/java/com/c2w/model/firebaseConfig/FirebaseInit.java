package com.c2w.model.firebaseConfig;
...
public class FirebaseInit {
      ...
      public static void initializeFirebase() throws IOException {
            ...
            FileInputStream(
                        "D:\\Projects\\Krushi_Sahayak\\krushi_sahayak\\farming\\src\\main\\resources\\krushi.json");
      ...
      public void createRec(String username, String info) throws InterruptedException,
            ...
            ApiFuture<WriteResult> future = db.collection("cropInfo").document("cereal crops").set(teamData);
      }
      ...
      public void fetchDocumentKeys(String collectionName, String documentId, TextArea textArea)
                  throws ExecutionException, InterruptedException {
      ...
      public static String uploadImages(String username, String localFilePath, String uploadFileName,
                  String description) {
